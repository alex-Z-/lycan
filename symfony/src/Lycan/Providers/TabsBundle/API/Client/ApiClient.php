...
namespace Lycan\Providers\TabsBundle\API\Client;

use Lycan\Providers\TabsBundle\API\Client\Middleware\HmacDigest as Hmac;
use Lycan\Providers\TabsBundle\API\Client\ApiException;
