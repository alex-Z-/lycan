...
namespace Lycan\Providers\LoveLegacyBundle\API\Client;

use Lycan\Providers\LoveLegacyBundle\API\Client\Middleware\HmacDigest as Hmac;
use Lycan\Providers\LoveLegacyBundle\API\Client\ApiException;


/**
 * LoveLegacy Rest API client
 *
...
class ApiClient
{
     ...
     *
     * @var LoveLegacy\api\client\HMAC
     */
    public $hmacHelper;

    /**
     * Create a new Api Connection for use within the LoveLegacy php client
     * api.
     *
    ...
    private function _setCurlOpt($follow = false)
    {
        ...
        curl_setopt(
            $this->resource,
            CURLOPT_USERAGENT,
            'LoveLegacy ApiClient (http://github.com/CarltonSoftware/tocc-api-client)'
        );
    }
