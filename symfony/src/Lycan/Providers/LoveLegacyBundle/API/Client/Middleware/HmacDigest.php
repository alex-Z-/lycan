 ...
 * for authentication with the LoveLegacy api given a provided username
 * and key.
 *
 * PHP Version 5.3
 * 
...
class HmacDigest
{
    ...
    static function encode($params, $key){
		return self::hmacEncode($params, $key->getSecret(), $key->getId());
	}
